...
const openCloseGeneratorButton = document.querySelector(
  ...
  const lenghtInput = document.querySelector(
    "#lenght"
  );

  const lettersInput = document.querySelector(
    "#letters"
  );

  const numbersInput = document.querySelector(
    "#numbers"
  );

  const symbolsInput = document.querySelector(
    "#symbols"
  );
...
copyPasswordButton = document.querySelector("#copy-password");
